###############################################################################
# analysis/execute_elastic_net_pipeline.R
#
# PURPOSE
...
source(file.path(REPO_DIR, "analysis", "compare_pooled_vs_within.R"))
...
source(file.path(REPO_DIR, "analysis", "fit_cv_lofocv.R"))
...
source(file.path(REPO_DIR, "analysis", "fit_cv_losocv.R"))
...
source(file.path(REPO_DIR, "figures_tables", "table_cv_performance.R"))
...
source(file.path(REPO_DIR, "figures_tables", "elastic_net_proxy_diagnostics.R"))
...
source(file.path(REPO_DIR, "figures_tables", "execute_supplier_diagnostics.R"))
